...
MUSIC_ERR = "Failed to load music\nPress any key to continue...",
...
void Resources::loadtexture()
{
	...
	// Attempt to load all the textures, and if any fails, throw an exception
	if (
	...
	{
		throw std::runtime_error(IMG_ERR);
	}
...
void Resources::loadMusic()
{
	...
	{
		throw std::runtime_error(MUSIC_ERR);
	}
