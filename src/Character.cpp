...
{
    // Update the character's movement and actions based on the delta time
...
{
    // Draw the character on the target
...
{
    // Set the texture index of the character
    m_indexCharcter = index;
}

int Character::getLives()
{
    // Get the number of lives of the character
    return m_lives;
}
